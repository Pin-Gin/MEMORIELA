...
export default function Home() {
  return <main>
    ...
    <section className="hero" id="home">
      ...
      <div className="heroVisual"><div className="heroYura"><Image src="/images/yura-dress.png" alt="久遠ゆら / YURA ドレスビジュアル" fill priority sizes="(max-width: 820px) 100vw, 60vw" /></div><div className="yuraSignature"><span>YURA</span><small>KUON YURA</small></div></div>
    </section>
