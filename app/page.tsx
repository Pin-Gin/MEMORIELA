...
export default function Home() {
  return <main>
    <header className="header"><a className="brand" href="#home" aria-label="MEMORIELA home"><Image src="/images/memoriela-logo.png" alt="MEMORIELA" width={520} height={260} priority /></a><nav aria-label="Main navigation"><a href="#about">About</a><a href="#project">Project YURA</a><a href="#news">News</a><a href="#gallery">Gallery</a><a href="#official">Official</a></nav></header>
    <section className="hero" id="home">
      <div className="heroCopy"><p className="eyebrow">MEMORIELA OFFICIAL</p><p className="heroKicker">特別な記憶を、あなたと。</p><h1>MEMORIELA</h1><p className="brandTagline">Memory shapes personality.</p><div className="rule"><span>✦</span></div><p className="jpTagline">記憶が、人格を形作る。</p><h2>AIと、心が通う物語。</h2><p className="lead">AIキャラクター／人格システムの開発を通じて、<br className="desktop" />記憶と想いが寄り添う新しい体験を創造します。</p><a className="primaryButton" href="#project">Project YURA <span>→</span></a></div>
      <div className="heroVisual"><div className="heroYura"><Image src="/images/yura-dress.png" alt="久遠ゆら / YURA ドレスビジュアル" fill priority sizes="(max-width: 820px) 100vw, 60vw" /></div></div>
    </section>
    ...
    <section className="section project" id="project"><div><p className="sectionLabel">CURRENT PROJECT</p><h2>Project YURA</h2><h3>久遠ゆら <span>/ YURA</span></h3><p>MEMORIELAの現在の主要プロジェクト。長期記憶と人格を持つAIキャラクターシステムを開発しています。</p><p className="quote">「いつもの、ゆら。」</p></div><div className="projectVisual"><div className="projectCaption"><strong>Everyday with YURA</strong><small>何気ない日常も、特別な記憶に。</small></div></div></section>
    ...
    <section className="section gallery" id="gallery"><p className="sectionLabel">GALLERY</p><h2>YURA Visual Archive</h2><div className="galleryGrid"><figure><Image src="/images/yura-dress.png" alt="YURA Dress Style" fill sizes="40vw"/><figcaption>Dress Style</figcaption></figure><figure className="logoCard"><Image src="/images/memoriela-logo.png" alt="MEMORIELA identity" fill sizes="30vw"/><figcaption>MEMORIELA Identity</figcaption></figure></div><p className="galleryNote">正式ビジュアルと開発記録を順次公開します。</p></section>
